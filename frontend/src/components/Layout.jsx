...
export default function Layout({ children }) {
  ...
  return (
    <div className="relative z-10 flex flex-col min-h-screen">
      {/* ── Top Navigation Bar ── */}
      <header className="border-b border-forge-border/80 bg-forge-bg/50 backdrop-blur-xl sticky top-0 z-50 shadow-lg shadow-black/10">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-violet-600 to-indigo-600 flex items-center justify-center
                            group-hover:from-violet-500 group-hover:to-indigo-500 transition-all duration-300 shadow-md shadow-violet-900/30">
            ...
            <span className="font-display font-bold text-lg tracking-tight text-forge-text group-hover:text-violet-350 transition-colors duration-200">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 rounded-xl text-xs font-semibold
                         ...
                         hover:border-red-900/35 hover:bg-red-900/10 transition-all duration-200 cursor-pointer"
            >
              {/* Logout icon */}
